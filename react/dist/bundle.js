...
var _lodashIsFunction2 = _interopRequireDefault(isFunction_1$1);
...
var _lodashFilter2 = _interopRequireDefault(filter_1);



var _lodashEvery2 = _interopRequireDefault(every_1);



var _lodashPick2 = _interopRequireDefault(pick_1);
...
unwrapExports(deepDiff);
var deepDiff_1 = deepDiff.DIFF_TYPES;
var deepDiff_2 = deepDiff.classifyDiff;
...
var getDisplayName_2 = getDisplayName_1.getDisplayName;
...
var defaultNotifier_1 = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, '__esModule', {
  value: true
});
...
unwrapExports(defaultNotifier_1);
var defaultNotifier_2 = defaultNotifier_1.defaultNotifier;
...
var normalizeOptions = function normalizeOptions() {
  ...
  var notifier = _opts$notifier === undefined ? defaultNotifier_1.defaultNotifier : _opts$notifier;
...
unwrapExports(normalizeOptions_1);
var normalizeOptions_2 = normalizeOptions_1.DEFAULT_INCLUDE;
var normalizeOptions_3 = normalizeOptions_1.DEFAULT_EXCLUDE;
var normalizeOptions_4 = normalizeOptions_1.normalizeOptions;
...
unwrapExports(shouldInclude_1);
var shouldInclude_2 = shouldInclude_1.shouldInclude;
...
function createComponentDidUpdate(opts) {
  return function componentDidUpdate(prevProps, prevState) {
    ...
    var propsDiff = (0, deepDiff.classifyDiff)(prevProps, this.props, displayName + '.props');
    if (propsDiff.type === deepDiff.DIFF_TYPES.UNAVOIDABLE) {
      return;
    }

    var stateDiff = (0, deepDiff.classifyDiff)(prevState, this.state, displayName + '.state');
    if (stateDiff.type === deepDiff.DIFF_TYPES.UNAVOIDABLE) {
      return;
    }
...
var hoistNonReactStatics$1 = function hoistNonReactStatics(targetComponent, sourceComponent, blacklist) {
...
selectorFactory) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    browser(typeof WrappedComponent == 'function', 'You must pass a component to the function returned by ' + ('connect. Instead received ' + JSON.stringify(WrappedComponent)));
 ...
 * of values.
 */
var nativeObjectToString$2 = objectProto$14.toString;
...
function getRawTag$2(value) {
  var isOwn = hasOwnProperty$14.call(value, symToStringTag$3),
 ...
 * of values.
 */
var nativeObjectToString$3 = objectProto$15.toString;
...
var Router$1 = function (_React$Component) {
  _inherits$3(Router, _React$Component);
...
var HashRouter = function (_React$Component) {
  _inherits$4(HashRouter, _React$Component);
  ...
  function HashRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$4(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHistory$1(_this.props), _temp), _possibleConstructorReturn$4(_this, _ret);
  }
...
var Link = function (_React$Component) {
  _inherits$5(Link, _React$Component);
  ...
  function Link() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$5(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (event) {
  ...
  Link.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties$3(_props, ['replace', 'to', 'innerRef']); // eslint-disable-line no-unused-vars
...
var MemoryRouter$1 = function (_React$Component) {
  _inherits$6(MemoryRouter, _React$Component);
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHistory$2(_this.props), _temp), _possibleConstructorReturn$6(_this, _ret);
  }
...
var NavLink = function NavLink(_ref) {
  var to = _ref.to,
      ...
      rest = _objectWithoutProperties$4(_ref, ['to', 'exact', 'strict', 'location', 'activeClassName', 'className', 'activeStyle', 'style', 'isActive', 'ariaCurrent']);
...
var Prompt$1 = function (_React$Component) {
  _inherits$8(Prompt, _React$Component);
...
var Redirect$1 = function (_React$Component) {
  _inherits$9(Redirect, _React$Component);
...
var StaticRouter$1 = function (_React$Component) {
  _inherits$10(StaticRouter, _React$Component);
  ...
  function StaticRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$10(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.createHref = function (path) {
  ...
  StaticRouter.prototype.render = function render() {
    var _props = this.props,
        ...
        props = _objectWithoutProperties$5(_props, ['basename', 'context', 'location']);
...
var Switch$1 = function (_React$Component) {
  _inherits$11(Switch, _React$Component);
...
function cats() {
	...
	switch (action.type) {
		case c.CATS_REQUESTED:
			return state;
		case c.CATS_RECEIVED:
			return action.payload;
		case c.CATS_RECEIVED_ERROR:
			return state;
		default:
			return state;
	}
...
if (!isNode$2()) {
	...
	store = createStore(reducers, setInitialState(), compose(applyMiddleware(logger, thunk), window.devToolsExtension ? window.devToolsExtension() : function (f) {
		return f;
	}));
	// #endif
	...
	requestCats: function requestCats() {
		...
		return function (dispatch) {
			return axios.get(url).then(function (response) {
				return dispatch({ type: c.CATS_RECEIVED, payload: sortByName(response.data) });
			}).catch(function (error) {
				return dispatch({ type: c.CATS_RECEIVED_ERROR, error: error });
			});
		};
	},
...
function Card(props) {
	return react.createElement(
		CardContainer,
		{ onClick: props.onClick(props.id), catSelected: props.catSelected === props.id },
...
var CardList = function (_Component) {
	inherits$1(CardList, _Component);
	...
	createClass$1(CardList, [{
		...
		value: function componentDidMount() {
			if (this.props.cats.length === 0) this.props.requestCats();
		}
	}, {
		...
		value: function _renderCards() {
			...
			return this.props.cats.map(function (cat) {
				return react.createElement(
					...
					react.createElement(Card, {
						...
						catSelected: _this2.props.catSelected,
						onClick: _this2.props.setSelected })
				);
			});
		}
	}, {
...
var Navigation = styled.nav(_templateObject$1, v$1.purple2, v$1.mobileBreakpoint, v$1.mobileBreakpoint);

var NavLinkStyled = styled(NavLink)(_templateObject2, v$1.grayB, v$1.time2 + v$1.ms, v$1.mobileBreakpoint);

var TransitionGroupStyled = styled(reactTransitionGroup_2)(_templateObject3);

var TabNavigator = function (_Component) {
	inherits$1(TabNavigator, _Component);

	function TabNavigator() {
		classCallCheck$1(this, TabNavigator);
		return possibleConstructorReturn$1(this, (TabNavigator.__proto__ || Object.getPrototypeOf(TabNavigator)).apply(this, arguments));
	}

	createClass$1(TabNavigator, [{
		key: "_getPage",
		value: function _getPage(pathname) {
			...
			return react.createElement(
				reactTransitionGroup_3,
				{ key: pathname, timeout: v$1.time2, classNames: "navigation-loader" },
				component
			);
		}
	}, {
		...
		value: function render() {
			return react.createElement(
				...
				react.createElement(
					...
					null,
					this._getPage(this.props.location.pathname)
				)
			);
		}
	}]);
...
function Routes() {
	return react.createElement(
		"div",
		null,
		react.createElement(Route$1, { path: "/", component: TabNavigator })
	);
}
