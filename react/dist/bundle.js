(function () {
	...
	*/
	...
	var isPlainObject$2 = (function (x) {
	  return (typeof x === 'undefined' ? 'undefined' : _typeof$5(x)) === 'object' && x.constructor === Object;
	});
	...
	var wrapAsElement = function wrapAsElement(css, names) {
	  return function () {
	    ...
	    return react.createElement('style', _extends$d({}, props, { dangerouslySetInnerHTML: { __html: css() } }));
	  };
	};
	...
	var StyleSheet = function () {
	  ...
	  StyleSheet.prototype.clone = function clone() {
	    ...
	    /* clone other maps */
	    sheet.rehydratedNames = _extends$d({}, this.rehydratedNames);
	    sheet.deferred = _extends$d({}, this.deferred);
	...
	function constructWithOptions(componentConstructor, tag) {
	  ...
	  templateFunction.withConfig = function (config$$1) {
	    return constructWithOptions(componentConstructor, tag, _extends$d({}, options, config$$1));
	  };

	  /* Modify/inject new props at runtime */
	  templateFunction.attrs = function (attrs) {
	    return constructWithOptions(componentConstructor, tag, _extends$d({}, options, {
	...
	var ThemeProvider = function (_Component) {
	  ...
	  ThemeProvider.prototype.getTheme = function getTheme(theme, outerTheme) {
	    ...
	    if (theme === null || Array.isArray(theme) || (typeof theme === 'undefined' ? 'undefined' : _typeof$5(theme)) !== 'object') {
	...
	var StyledComponent = function (_Component) {
	  ...
	  StyledComponent.prototype.renderInner = function renderInner(theme) {
	    ...
	    var propsForElement = {};
	    var computedProps = _extends$d({}, this.attrs, this.props);
	    ...
	    if (this.props.style && this.attrs.style) {
	      propsForElement.style = _extends$d({}, this.attrs.style, this.props.style);
	    }
	  ...
	  StyledComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props, attrs) {
	    ...
	    var context = _extends$d({}, props, { theme: theme });
	...
	function createStyledComponent(target, options, rules) {
	  ...
	  var WrappedStyledComponent = react.forwardRef(function (props, ref) {
	    return react.createElement(ParentComponent, _extends$d({}, props, { forwardedComponent: WrappedStyledComponent, forwardedRef: ref }));
	  });
	  ...
	  WrappedStyledComponent.withComponent = function withComponent(tag) {
	    ...
	    var newOptions = _extends$d({}, optionsToCopy, {
	      attrs: finalAttrs,
	          ...
	          if (globalStyle.isStatic) {
	            ...
	            return react.createElement(
	              ...
	              function (theme) {
	                ...
	                var context = _extends$d({}, _this2.props);
	...
	/*#__PURE__*/
	function (_Component) {
	  _inherits$a(CardList, _Component);
	  ...
	  function CardList() {
	    ...
	    _classCallCheck$a(this, CardList);

	    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    _this = _possibleConstructorReturn$a(this, (_getPrototypeOf2 = _getPrototypeOf(CardList)).call.apply(_getPrototypeOf2, [this].concat(args)));
	    ...
	    _defineProperty$1(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "shouldComponentUpdate", function (_ref) {
	      var cats = _ref.cats,
	          catSelected = _ref.catSelected;
	      return cats.length !== _this.props.cats.length || catSelected !== _this.props.catSelected;
	    });

	    _defineProperty$1(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "_renderCards", function () {
	    ...
	    _defineProperty$1(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "render", function () {
	...
	_defineProperty$1(CardList, "propTypes", {
	  catSelected: propTypes.string,
	...
	/*#__PURE__*/
	function (_React$Component) {
	  _inherits$a(TabNavigator, _React$Component);
	  ...
	  function TabNavigator() {
	    ...
	    _classCallCheck$a(this, TabNavigator);

	    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }

	    _this = _possibleConstructorReturn$a(this, (_getPrototypeOf2 = _getPrototypeOf(TabNavigator)).call.apply(_getPrototypeOf2, [this].concat(args)));

	    _defineProperty$1(_assertThisInitialized$1(_assertThisInitialized$1(_this)), "_getPage", function (pathname) {
	      var component;
	...
	_defineProperty$1(TabNavigator, "propTypes", {
	  location: propTypes.object
	});
	...
	function App() {
	  return react.createElement(Provider, {
	    store: store
	  }, react.createElement(HashRouter, null, react.createElement(Routes, null)));
	}
