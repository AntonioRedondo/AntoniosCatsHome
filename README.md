...
React (TypeScript) | 260 | - (no native CSS) | 1 | 0 (plus fonts) | React 16.7 | Axios | React Router | ReactTransitionGroup | Redux, Reselect | styled-components using BEM | npm, Gulp, Rollup | [TSLint](https://www.npmjs.com/package/gulp-tslint), stylelint | Jest on Node.js | :heavy_check_mark: | Node.js | [HTML](https://antonioredondo.github.io/AntoniosCatsHome/react/README.htm) | On [`dist`](react/dist) folder
