...
| React | 336 | 3 | 1 | 1 (plus fonts) | ES6 React 15.6 | [React Router](https://www.npmjs.com/package/react-router) | [ReactTransitionGroup](https://www.npmjs.com/package/react-transition-group) | Redux, Reselect | [styled-components](https://www.npmjs.com/package/styled-components), PostCSS (with BEM) | npm, Gulp, Rollup | [ESLint](https://www.npmjs.com/package/gulp-eslint), [stylelint](https://stylelint.io) | Jest | Node.js | [HTML](https://antonioredondo.github.io/AntoniosCatsHome/react/README.htm) | On [`dist`](react/dist) folder |
